...
{
    var $eng_to_bn = array('0'=>'০','1'=>'১', '2'=>'২', '3'=>'৩', '4'=>'৪', '5'=>'৫','6'=>'৬', '7'=>'৭', '8'=>'৮', '9'=>'৯', '0'=>'০');
    ...
    public function numToWord($number){
        ...
        if(is_float($number)){
            ...
            //This part is added by Imran
            if ($dot[1]<=9){
                $dot[1].="0";
            }

            return $this->numberSelector($dot[0]).' টাকা '.$this->numberSelector($dot[1]).' পয়শা মাত্র।';
//            return $this->numberSelector($dot[0]).' টাকা '.$this->numToBnDecimal($dot[1]).' পয়শা মাত্র।';
        }else{
...
//        $number = ($number == 0)?'': $this->numToBn($number);
        $number = $this->numToBn($number); //My modification
        return $number;
    }
...
//        if ($b==0){return $hundred.''.$this->underHundred($b);}
        if ($b==0){return $hundred;}    //My modification
    ...
    public function thousand($number){
        ...
        if ($b==0){return $thousand.''.$this->hundred($b);}     //My modification
    ...
    public function lakh($number){
        ...
        if ($b==0){return $lakh.''.$this->thousand($b);}
    ...
    public function crore($number){
        ...
        if ($b==0){return $more_than_core.' '.$this->crore.''.$this->lakh($b);}     //My modification
