                ...
                <div class="col-xl-12">
                    <div class="page-title" style="">
                        ...
                        <div class="breadcrumb-list text-left">
                            <ul>
{{--                                <li>{{ 'Home' }}</li>--}}
                                <li><a href="{{ route('all-popular-ecas') }}">{{ 'Our Key Facilities' }}</a></li>
                                <li>{{ $eca->title }}</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="blog-wrapper mb-30">
                        <article class="post-item format-standard mb-30">
                            @if( $eca->thumbnail != null)
                            <div class="post-thumb">
                                <a href="#"><img src="{{ $eca->thumbnail != null? asset($eca->thumbnail) : '' }}" alt="blog"></a>
                            </div>
                            @endif

                            <div class="post-content">
                                <div class="post-meta mb-20">
                                    <span><a href="#"><i class="far fa-calendar-alt"></i> {{ dateFormat($eca->updated_at,'d M Y') }}</a></span>
