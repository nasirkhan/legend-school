            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card overflow-hidden">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-4">
                                    <h5 class="text-primary"> Teacher's Portal !!!</h5>
                                    <p>{{ siteInfo('name') }}</p>
                                </div>
                            </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-2">
                            <form class="form-horizontal" method="POST" action="{{ route('teacher-login') }}">
                                @csrf
                                <div class="form-group">
                                    <label for="uid">{{ __('Mobile or Email') }}</label>
                                    <input type="text" class="form-control" id="uid" name="uid" value="{{ old('uid') }}" required autofocus>
                                </div>
