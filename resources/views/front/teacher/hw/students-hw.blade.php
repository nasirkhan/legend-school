    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Students HW List</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">{{ 'Dashboard' }}</li>
                        <li class="breadcrumb-item active"><a href="{{ route('students-hw-check-by-teacher') }}">Students HW List</a></li>
                    </ol>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary font-weight-bold mb-3"><i class="fa fa-list"></i> Class Wise HW List
{{--                        <a href="{{ route('teacher-hw-add-form') }}" class="btn btn-primary btn-sm">Go To HW Add Form</a>--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg">
                            <button class="btn btn-primary btn-block" onclick="getStudentHWByTeacher()"><i class="fa fa-paper-plane"></i> Get Home Work List</button>
                        </div>
                    </div>
                </div>
            </div>
