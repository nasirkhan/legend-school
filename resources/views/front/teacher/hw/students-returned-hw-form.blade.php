    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Returned HW List</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">{{ 'Dashboard' }}</li>
                        <li class="breadcrumb-item active"><a href="{{ route('students-hw-check-by-teacher') }}">Returned HW List</a></li>
                    </ol>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary font-weight-bold mb-3"><i class="fa fa-list"></i> Class Wise Returned HW List
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg pr-lg-0 mb-3">
                            <div class="input-group">
                                ...
                                <select name="subject_id" class="form-control" required onchange="getSubjectHomeWorks()">
                                    <option value="">--Select--</option>
                        ...
                        <div class="col-lg pr-lg-0 mb-3">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">HW</span>
                                </div>

                                <select name="hw_id" class="form-control" required>
                                    <option value="">--Select--</option>
                                    @php($hws = teacherClassSubjectHWs(Session::get('year'),Session::get('class_id'),Session::get('subject_id')))
                                    @foreach($hws as $hw)
                        ...
                        <div class="col-lg">
                            <button class="btn btn-primary btn-block" onclick="getReturnedHWByTeacher()"><i class="fa fa-paper-plane"></i> Get Home Work List</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="table" class="table-responsive p-1">
                        @include('front.teacher.hw.students-submitted-hw')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
