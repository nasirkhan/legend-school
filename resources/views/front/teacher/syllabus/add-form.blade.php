    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">{{ $teacher->name }}'s Syllabus Add Form</h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('teacher-hw-add-form') }}">Syllabus Add Form</a></li>
                    </ol>
                </div>
...
@section('content')
    @include('front.teacher.syllabus.form-container')
