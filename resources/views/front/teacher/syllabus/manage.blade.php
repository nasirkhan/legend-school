    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">{{ $teacher->name }}'s Syllabus List</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">{{ 'Dashboard' }}</li>
                        <li class="breadcrumb-item active"><a href="{{ route('syllabus-view-by-teacher') }}">Syllabus View</a></li>
                    </ol>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary font-weight-bold mb-3">Exam Wise Syllabus
                        <a href="{{ route('syllabus-add-by-teacher') }}" class="btn btn-primary btn-sm">Go To Syllabus Add Form</a>
                    </h5>
                    <div class="row">
...
{{--                                    @endforeach--}}
                        ...
                        <div class="col-lg-3">
                            <button class="btn btn-primary btn-block" onclick="location.reload()"><i class="fa fa-paper-plane"></i> Check Syllabus List</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="table" class="table-responsive p-1">
                        @include('front.teacher.syllabus.table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
