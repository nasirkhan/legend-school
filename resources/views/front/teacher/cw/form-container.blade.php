    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body" id="addForm">
                <h5 class="card-title text-primary font-weight-bold mb-3">Class Activity Add Form <a href="{{ route('teacher-class-wise-cw-list') }}" class="btn btn-primary btn-sm"> Go To Class Activity List</a></h5>
                <form class="" action="{{ route('teacher-cw-save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="chapter" class="form-control" placeholder="Chapter Name or Topic Name etc." required/>
                            </div>
                        </div>

                        <div class="col-lg-12 mb-3">
                            <label>Lecture Detail</label>
                            <textarea class="summernote" name="cw_detail"></textarea>
                        </div>
