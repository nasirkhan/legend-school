        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary font-weight-bold mb-3">Class Wise Activity List
                        <a href="{{ route('teacher-class-activity-add-form') }}" class="btn btn-primary btn-sm">Go To Class Activity Add Form</a>
                    </h5>
                    <div class="row">
...
{{--                                    @endforeach--}}
                        ...
                        <div class="col-lg-3">
                            <button class="btn btn-primary btn-block" onclick="location.reload()"><i class="fa fa-paper-plane"></i> Check Class Activity List</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="table" class="table-responsive p-1">
                        @include('front.teacher.cw.table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
