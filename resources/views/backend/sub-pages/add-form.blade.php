        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body" id="addForm">
                    ...
                    <form class="" action="{{ route('sub-page-save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="page_id">
                                        ...
                                        @foreach($menus as $menu)
                                            <option value="{{ $menu->id }}">{{ $menu->menu_txt }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5 pr-md-0 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="menu_txt" class="form-control" required/>
                                </div>
                            </div>
