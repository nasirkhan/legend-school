...
@section('document-title') Credit Sale Report @endsection
@section('page-title')  Credit Sale Report  @endsection
@section('active-breadcrumb-item') <a href="{{ route('credit-sale-report') }}"> Credit Sale Report </a> @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="form" action="{{ route('date-to-date-credit-sale-report') }}" method="POST">
                                @csrf
                                <div class="row">
...
{{--                        <div class="col-lg-2">--}}
{{--                            <form target="_blank" action="{{ route('date-to-date-credit-sale-report') }}" method="POST">--}}
{{--                                @csrf--}}
...
{{--                        </div>--}}
                ...
                <div class="card-body">
{{--                    <h4 class="card-title text-primary"> Credit Sale Invoices</h4>--}}
                    <div id="table" class="table-responsive p-1">
                        @include('backend.report.income.credit-sale-table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
