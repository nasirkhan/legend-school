...
@section('document-title') Transport and Labour Cost @endsection
@section('page-title') Transport and Labour Cost @endsection
@section('active-breadcrumb-item') <a href="{{ route('transport-and-labour-cost-report') }}">Transport and Labour Cost</a> @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="form" action="{{ route('date-to-date-transport-and-labour-cost-report') }}" method="POST">
                                @csrf
                                <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div id="table" class="table-responsive p-1">
                        @include('backend.report.expense.transport-labour-table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
...
@section('modal') @include('backend.report.expense.expense-edit-form') @endsection

@section('special-js') @include('backend.report.expense.expense-report-script') @endsection
