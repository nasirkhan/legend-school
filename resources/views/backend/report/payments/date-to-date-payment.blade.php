...
@section('document-title') Date Wise Payment Report @endsection
@section('page-title') Date Wise Payment Report @endsection
@section('active-breadcrumb-item') <a href="{{ route('report-form',['from'=>'payment','type'=>'date-to-date']) }}">Date Wise Payment Report</a> @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-10">
                            <form id="form" action="{{ route('report') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-5 pr-lg-1">
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="start" id="startDate" class="form-control" value="{{ date('Y-m-d') }}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-5 pr-lg-1">
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="end" id="endDate" class="form-control" value="{{ date('Y-m-d') }}"/>
                                        </div>
                                    </div>
                                    <input type="hidden" name="from" value="payment"/>
                                    <input type="hidden" name="report_type" value="date-to-date">
...
{{--                    <h4 class="card-title text-primary">Cash Sale Invoices</h4>--}}
                    <div id="table" class="table-responsive p-1">
                        @include('backend.report.payments.table')
