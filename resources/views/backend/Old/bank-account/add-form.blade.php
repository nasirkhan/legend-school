<div class="card-body" id="addForm">
    <h5 class="card-title text-primary mb-3">Bank Account Add Form</h5>
    <form class="" action="{{ route('bank-account-save') }}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col col-md-6">
                <div class="form-group row">
                    <div class="col"><button type="submit" class="btn btn-block btn-primary mr-2"><i class="fa fa-save"></i> Save</button></div>
                    <div class="col"><button type="reset" class="btn btn-block btn-warning"><i class="fa fa-times-circle"></i> Reset</button></div>
                </div>
            </div>
        </div>
    </form>
