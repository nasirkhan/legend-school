    ...
    <form class="due" action="{{ route('due-transaction') }}" method="POST">
        ...
        <div class="row">
            <div class="col-12 pl-lg-0">
                <div class="card">
                    <div class="card-header font-weight-bold text-info f-s-small"><i class="bx bx-money"></i> Payment Details</div>
                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            <tr>
                                ...
                                <th class="p-1">
                                    <div class="row">
                                        <div class="col pr-1">
                                            <button type="submit" name="status" id="sale" value="1" class="btn btn-sm btn-primary mr-2" style="font-size: 13px"><i class="fa fa-save"></i> Complete Payment</button>
                                        </div>
{{--                                        <div class="col pl-1">--}}
