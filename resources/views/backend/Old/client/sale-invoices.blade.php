...
@section('document-title') Cash-Credit Sale Invoices @endsection
@section('page-title') Cash-Credit Sale Invoices @endsection
@section('active-breadcrumb-item') <a href="#">Cash-Credit Sale Invoices</a> @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-10">
                            <form id="form" action="{{ route('date-to-date-sale-invoices') }}" method="POST">
                                @csrf
                                <div class="row">
                        ...
                        <div class="col-lg-2">
                            <form target="_blank" action="{{ route('date-to-date-sale-invoices') }}" method="POST">
                                @csrf
                ...
                <div class="card-body">
                    <h4 class="card-title text-primary">{{ 'Cash-Credit Sale Invoices' }}</h4>
                    <div id="table" class="table-responsive p-1">
                        @include('backend.client.sale-invoices-table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
