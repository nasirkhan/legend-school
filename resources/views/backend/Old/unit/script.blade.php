<script>
    ...
    function editForm(sl){
      $("#addForm").hide();
      $("#editForm").show();
      $("#editForm form select[name=measurement_category_id]").val(data.measurement_category_id);
    ...
    function statusUpdate(id,sl) {
      $(".loader").show();
      $.get("{{ route('unit-status-update') }}",{id:id,sl:sl}, (response)=>{
        updatedData = response;
        let table = $("#datatable").DataTable();
    ...
    function itemDelete(id,sl) {
      $(".loader").show();
      $.get("{{ route('unit-delete') }}",{id:id,sl:sl}, (response)=>{
          if (response.success){
              console.log(response);
              let table = $("#datatable").DataTable();
