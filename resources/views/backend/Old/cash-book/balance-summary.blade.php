...
@section('document-title') Balance Summary @endsection
@section('page-title') Balance Summary @endsection
@section('active-breadcrumb-item') <a href="{{ route('balance-summary') }}">Balance Summary</a> @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="form" action="{{ route('date-to-date-balance-summary') }}" method="POST">
                                @csrf
                                <div class="row">
...
{{--                        <div class="col-lg-2">--}}
{{--                            <form target="_blank" action="{{ route('date-to-date-balance-summary') }}" method="POST">--}}
{{--                                @csrf--}}
...
{{--                    <h4 class="card-title text-primary"> List</h4>--}}
                    <div id="table" class="table-responsive p-1">
                        @include('backend.cash-book.balance-summary-table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
