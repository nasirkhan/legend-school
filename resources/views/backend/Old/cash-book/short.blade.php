...
@section('document-title') Cash Book @endsection
@section('page-title') Today Cash Book @endsection
@section('active-breadcrumb-item') <a href="{{ route('cash-book') }}"> Today Cash Book </a> @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="form" action="{{ route('date-to-date-cash-book') }}" method="POST">
                                @csrf
                                <div class="row">
...
{{--                        <div class="col-lg-2">--}}
{{--                            <form target="_blank" action="{{ route('date-to-date-cash-book') }}" method="POST">--}}
{{--                                @csrf--}}
...
{{--                    <h4 class="card-title text-primary"> List</h4>--}}
                    <div id="table" class="table-responsive p-1">
                        @include('backend.cash-book.short-table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
