...
@section('document-title') Profit-Loss Statement @endsection
@section('page-title') Profit-Loss Statement @endsection
@section('active-breadcrumb-item') <a href="{{ route('profit-loss') }}">Profit-Loss Statement</a> @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="form" action="{{ route('date-to-date-profit-loss') }}" method="POST">
                                @csrf
                                <div class="row">
...
{{--                        <div class="col-lg-2">--}}
{{--                            <form target="_blank" action="{{ route('date-to-date-profit-loss') }}" method="POST">--}}
{{--                                @csrf--}}
...
{{--                    <h4 class="card-title text-primary"> List</h4>--}}
                    <div id="table" class="table-responsive p-1">
                        @include('backend.cash-book.profit-loss-table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
...
@section('script') @include('backend.cash-book.script') @endsection
{{--this style override all--}}
@section('style') @include('backend.cash-book.style') @endsection
