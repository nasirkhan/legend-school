<script>
      ...
      $.ajax({
        ...
        success: (response) => {
          ...
          let table = $("#datatable").DataTable();
            ...
            let category = '<td>'+response.name+'</td>';
           ...
           let tr = table.row.add( [ sl, category, status, action ] ).draw().node();
    ...
    function statusUpdate(id,sl) {
      $(".loader").show();
      $.get("{{ route('category-status-update') }}",{id:id,sl:sl}, (response)=>{
        updatedData = response;
        let table = $("#datatable").DataTable();
    ...
    function itemDelete(id,sl) {
      $(".loader").show();
      $.get("{{ route('category-delete') }}",{id:id,sl:sl}, (response)=>{
          if (response.success){
