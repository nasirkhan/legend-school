...
@section('document-title') Class Wise Result Delete Form @endsection
@section('page-title') Class Wise Result Delete Form @endsection
@section('active-breadcrumb-item') <a href="{{ route('result',['from'=>'delete']) }}">Class Wise Result Delete Form</a> @endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg pr-lg-0">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control pl-2" name="section_id" onchange="getClasses(this.value)">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-lg pr-lg-0">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control pl-2" name="class_id" onchange="getExam(); getSubject(this.value)">
                                            <option value="">--Select--</option>
                                ...
                                <div class="col-lg pr-lg-0">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control pl-2" name="exam_id" id="exam_id" onchange="">
                                            <option value="">--Select-- </option>
                                ...
                                <div class="col-lg">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control pl-2" name="subject_id" id="subject_id">
                                            <option value="">--Select--</option>
                        ...
                        <div class="col-lg-1">
                            <button type="button" onclick="getExamWiseResultForDelete()" class="btn btn-block btn-primary">Submit</button>
                        </div>
                    </div>
