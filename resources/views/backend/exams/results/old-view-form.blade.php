...
@section('document-title') Class Wise Old Result View Form @endsection
@section('page-title') Class Wise Old Result View Form @endsection
@section('active-breadcrumb-item') <a href="{{ route('result',['from'=>'old']) }}">Class Wise Old Result View Form</a> @endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-1">
                            <button type="button" onclick="getExamWiseOldResult()" class="btn btn-block btn-primary">Submit</button>
                        </div>
                    </div>
