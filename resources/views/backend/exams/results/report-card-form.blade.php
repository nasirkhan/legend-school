...
@section('document-title') Student Exam Report @endsection
@section('page-title') Student Exam Report @endsection
@section('active-breadcrumb-item') <a href="{{ route('result',['from'=>'add']) }}">Student Exam Report</a> @endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-1">
                            <button type="button" onclick="getReportCards()" class="btn btn-block btn-primary">Submit</button>
                        </div>
                    </div>
