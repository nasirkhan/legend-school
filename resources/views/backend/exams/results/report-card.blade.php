            ...
            <tr>
                <td class="b-w p-0">
                    <table class="student-info">
                        ...
                        <tr>
                            <td colspan="2" style="text-align: left"><b>Total No. of Class:</b>
                                <input
                                    type="number" id="no_of_class"
                                    value="{{ $meta['no_of_class'] }}"
                                    onchange="resultMetaInfoAdd(this)"
                                    onkeyup="resultMetaInfoAdd(this)"
                                    onclick="this.select()"
                                    placeholder=""
                                    step="1"
                                    min="0"
                            ...
                            <td style="text-align: left"><b>Total Present:</b>
                                <input
                                    type="number" id="no_of_class_present"
                                    value="{{ $meta['no_of_class_present'] }}"
                                    onchange="resultMetaInfoAdd(this)"
                                    onkeyup="resultMetaInfoAdd(this)"
                                    onclick="this.select()"
                                    placeholder=""
                        ...
                        <tr>
                            <td colspan="2" style="text-align: left"><b>Parent-Teacher Meeting(PTM):</b>
                                <input
                                    type="number" id="ptm"
                                    value="{{ $meta['ptm'] }}"
                                    onchange="resultMetaInfoAdd(this)"
                            ...
                            <td style="text-align: left"><b>Attended:</b>
                                <input
                                    type="number" id="ptm_attended"
                                    value="{{ $meta['ptm_attended'] }}"
                                    onchange="resultMetaInfoAdd(this)"
                                    onkeyup="resultMetaInfoAdd(this)"
                                    onclick="this.select()"
                                    placeholder="1"
                        ...
                        @if($exam->need_promo_status==1)
                            <tr>
                                <td colspan="3" style="text-align: left"><b>Promoted To:</b>
                                    <select id="promoted_class_id" name="promoted_class_id"
                                            onchange="promotedToNextClass(this)"
                                    >
                                        <option value="">--Select Class--</option>
                                        @foreach(classes() as $class)
                                            <option value="{{ $class->id }}" {{ $class->id==$meta['promoted_class_id']? 'selected':'' }}>{{ $class->name }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="p-0 b-w">
                        <table  style="margin-top: 2px">
                            <tr>
                                <th class="b-w txt-l" style="font-size: 13px">Comment: </th>
                                <th class="b-w txt-l p-0" style="width: 80%;">
                                    <textarea name="comment" style="width: 100%; height: 100px;">{{ isset($comment) ? $comment->comment : '' }}</textarea>
...
{{--            {{ siteInfo('name') }}. All Rights Reserved. | --}}
    ...
    @include('backend.exams.results.result-meta-script')
</div>
</body>
</html>
