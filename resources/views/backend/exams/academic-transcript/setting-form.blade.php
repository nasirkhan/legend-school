...
@section('document-title') Student Academic Transcript Setting Form @endsection
@section('page-title') Student Academic Transcript Setting Form @endsection
@section('active-breadcrumb-item') <a href="{{ route('result',['from'=>'add']) }}">Student Academic Transcript Setting Form</a> @endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <form id="form" action="{{ route('transcript-setting-save') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg pr-lg-0">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control pl-2" name="class_id" onchange="getExam(); clearTable();">
                                                <option value="">--Select--</option>
...
{{--                                    </div>--}}
                            ...
                            <div class="col-lg-2">
                                <button type="button" onclick="getClassWiseExamsForTranscriptSettings()" class="btn btn-block btn-primary"><i class="fa fa-list-alt"></i> Get Exam List</button>
                            </div>
                        </div>
...
@section('script') @include('backend.exams.academic-transcript.script') @endsection
{{--this style override all--}}
@section('style') @include('backend.exams.academic-transcript.style') @endsection
