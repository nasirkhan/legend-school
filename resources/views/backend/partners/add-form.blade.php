...
@section('document-title') Latest News Add Form @endsection
@section('page-title') Latest News Add Form @endsection
@section('active-breadcrumb-item') <a href="{{ route('latest-news-add-form') }}">Latest News Add Form</a> @endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary mb-3">Add New News</h5>
                    <form class="" action="{{ route('latest-news-save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-3 pr-md-0 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="author" class="form-control" value="{{ old('author') }}" placeholder="Author Name" required/>
                                </div>
                            </div>

                            <input type="hidden" name="sl" class="form-control" value="{{ empty(old('sl')) ? $sl : old('sl') }}" required/>
                            ...
                            <div class="col-md-2 pr-md-0 mb-3">
                                <div class="input-group">
                                    ...
                                    <select name="front_page_status" class="form-control" required>
                                        <option value="2" {{ old('front_page_status') == 2? 'selected' : '' }}>No</option>
                                        <option value="1" {{ old('front_page_status') == 1? 'selected' : '' }}>Yes</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control summernote" rows="10" name="page_content"></textarea>
                            </div>
