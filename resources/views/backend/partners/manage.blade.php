...
@section('document-title') Partner Management @endsection
@section('page-title') Partner Management @endsection
@section('active-breadcrumb-item') <a href="{{ route('partners') }}">Partner Management</a> @endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary mb-3">Add New Partner</h5>
                    <form class="" action="{{ route('partner-save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
