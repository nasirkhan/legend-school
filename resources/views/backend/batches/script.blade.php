<script>
    ...
    $("#addForm form").submit(function (e) {
        ...
        $.ajax({
            ...
            success: (response) => {
                ...
                let class_name = '<td>'+response.class_name+'</td>';
                ...
                let tr = table.row.add( [ sl, class_name, name, status, action ] ).draw().node();
    ...
    function statusUpdateConfirmation(id,sl){
      Swal.fire({
        title: 'Are you sure?',
        text: "Do you want to update this sub section status ?",
        icon: 'warning',
    ...
    function itemDeleteConfirmation(id,sl){
        Swal.fire({
            title: 'Are you sure?',
            text: "Do you want to delete this sub section ?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
