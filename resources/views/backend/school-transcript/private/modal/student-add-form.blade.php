<div id="studentAddForm" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <form action="{{ route('private-student-save') }}" method="post" style="width: 100%">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0"><i class="fa fa-user"></i> New Student Add Form<span id="title"></span></h5>
...
{{--                    <div class="input-group mb-3">--}}
{{--                        <div class="input-group-prepend">--}}
{{--                            <span class="input-group-text">Grade(Class)</span>--}}
{{--                        </div>--}}
{{--                        <select class="form-control pl-2" name="grade" required>--}}
{{--                            <option value="">--Select--</option>--}}
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="select2 form-control" multiple="multiple"  name="subject_id[]" required style="width: 90%">
                            ...
                            @foreach(activeSubjects(1) as $subject)
                                <option value="{{ $subject->id }}">{{ $subject->sub_code }} : {{ $subject->name }}</option>
                            @endforeach
                        </select>
                    </div>
