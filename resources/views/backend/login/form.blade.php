                        ...
                        <div class="p-2">
                            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <label for="username">{{ __('Email or Mobile No.') }}</label>
                                    <input type="text" class="form-control" id="username" name="login" value="{{ old('login') }}" required autofocus>
                                </div>

                                <div class="form-group">
                                    <label for="userpassword">{{ __('Password') }}</label>
                                    <input type="password" class="form-control" id="userpassword" name="password" required autocomplete="current-password" >
                                </div>
