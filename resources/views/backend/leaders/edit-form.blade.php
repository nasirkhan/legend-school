        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary mb-3">Leader Info Edit</h5>
                    <form class="" action="{{ route('leader-update',['id'=>$leader->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-5 pr-md-0 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" value="{{ $leader->name }}" class="form-control" required/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5 pr-md-0 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="designation" value="{{ $leader->designation }}" class="form-control" required/>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="short_description" value="{{ $leader->short_description }}" class="form-control" required/>
                                </div>
                            </div>

                            <div class="col-12 mb-3">
                                <label>Long Description</label>
                                <textarea class="form-control summernote" rows="10" name="description">{!! $leader->description !!}</textarea>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-3">
                                ...
                                <img width="100%" class="img-thumbnail" id="thumbnail_show" src="{{ asset($leader->thumbnail) }}" alt="">
                            </div>
                        </div>
                    </form>
                </div>
