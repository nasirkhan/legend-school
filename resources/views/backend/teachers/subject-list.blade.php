...
@section('document-title') Class Schedule @endsection
@section('page-title') Teachers Management @endsection
@section('active-breadcrumb-item')
    <a href="{{ route('teachers') }}">Teachers Management</a>
    <a href="{{ route('teacher-subject-list',['id'=>$teacher->id, 'sectionId'=>$sectionId]) }}">Class Schedule</a>
@endsection
...
@section('content')
    ...
    @include('backend.teachers.modal.routine-add-form')
@endsection
