...
@section('active-breadcrumb-item') <a href="{{ route('popular-class-edit',['id'=>$page->id]) }}">Page Edit</a> @endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body" id="addForm">
                    ...
                    <form class="" action="{{ route('popular-class-update',['id'=>$page->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-7 pr-md-0 mb-3">
                            ...
                            <div class="col-md-2 pr-md-0 mb-3">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" style="width: 100%">SL</span>
                                    </div>
                                    <input type="text" name="sl" class="form-control" value="{{ $page->sl }}" required/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 pr-md-0 mb-3">
                                <div class="input-group">
                                    ...
                                    <select name="front_page_status" class="form-control" required>
                                        <option value="2" {{ $page->front_page_status == 2? 'selected' : '' }}>No</option>
                                        <option value="1" {{ $page->front_page_status == 1? 'selected' : '' }}>Yes</option>
                                    </select>
                                </div>
                            </div>
...
@section('script') @include('backend.popular-classes.script') @endsection
