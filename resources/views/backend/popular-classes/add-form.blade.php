...
@section('document-title') Popular ECA Add Form @endsection
@section('page-title') Popular ECA Add Form @endsection
@section('active-breadcrumb-item') <a href="{{ route('popular-class-add-form') }}">Popular ECA Add Form</a> @endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary mb-3">Add New Page</h5>
                    <form class="" action="{{ route('popular-class-save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-7 pr-md-0 mb-3">
                            ...
                            <div class="col-md-2 pr-md-0 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="sl" class="form-control" value="{{ empty(old('sl')) ? $sl : old('sl') }}" required/>
                                </div>
                            </div>
