...
{{--                                                <option value="{{ $class->id }}">{{ $class->name }}</option>--}}
                        ...
                        <div class="col-lg-2">
                            <button type="button" onclick="getClassWiseStudentForPasswordSend()" class="btn btn-block btn-primary"><i class="fa fa-list-alt"></i> Get List</button>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div id="table" class="table-responsive p-1">
                        @include('backend.students.list.password-table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
