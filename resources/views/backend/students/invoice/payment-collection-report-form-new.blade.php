...
@section('active-breadcrumb-item') <a href="{{ route('payment-collection-report-new') }}">Payment Collection Report Form</a> @endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-1">
                            <button type="button" onclick="getPaymentReportNew()" class="btn btn-block btn-primary">
                    ...
                    <div id="table" class="table-responsive p-0 mt-2">
                        @include('backend.students.invoice.payment-report-table-new')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
