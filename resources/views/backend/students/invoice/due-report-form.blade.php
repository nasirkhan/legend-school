            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <button type="button" onclick="getDueReport()" class="btn btn-block btn-primary"><i class="fa fa-list-alt"></i> Get Report</button>
                        </div>
                    </div>
                    <div id="table" class="table-responsive p-1">
                        @include('backend.students.invoice.due-table')
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
