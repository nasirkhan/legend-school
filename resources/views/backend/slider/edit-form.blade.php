        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body" id="addForm">
                    <h5 class="card-title text-primary mb-3">Edit Slide</h5>
                    <form class="" action="{{ route('slide-update',['id'=>$slide->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="page_link" value="{{ $slide->page_link }}" class="form-control"/>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-3">
                                ...
                                <img width="100%" class="img-thumbnail" id="thumbnail_show" src="{{ asset($slide->url) }}" alt="">
                            </div>
                        </div>
                    </form>
                </div>
